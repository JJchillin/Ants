...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if hasattr(insect, 'royal') and not insect.imposter:
                return
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place != hive:
            ...
            b = place.bees
            count += 1
            if b and place != hive and self.min_range <= count <= self.max_range:
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        # BEGIN Problem 6
        if self.digesting == 0 and self.place == bee.place:
        ...
        if place.ant:
            ...
            if place.ant.is_container:
                if place.ant.contained_ant:
                    if place.ant.contained_ant.doubled == False:
...
def apply_effect(effect, bee, duration):
    ...
    def applied_effect(colony):
        ...
        if duration:
            duration -= 1
            return new_act(colony)
        else:
            return old_act(colony)
